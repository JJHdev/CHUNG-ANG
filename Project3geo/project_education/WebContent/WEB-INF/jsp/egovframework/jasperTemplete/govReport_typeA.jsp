...
<head>
	...
	<script src="${pageContext.request.contextPath}/js/jasperTemplete/govReport_typeA.js"></script>
		...
		<article class="conFrame" id="frame1">
			...
			<header>
				<div>
					...
					<h2 class="report_title">폭염 영향예보 (제 #-##호) <b>[전국]</b></h2>
				</div>
				<div>
			...
			<div class="conPart">
				...
				<div class="conInner healthTotal">
					...
					<div class="mapInclude">
						...
						<div class="map">
							<div id="health_map" style="width:200%; height:200%; -webkit-transform:scale(0.5); -webkit-transform-origin:0% 0%; background:white; display:block; pointer-events: none;"></div>
							<div class="ulleungdo_map">
									...
									<tr>
										<td class="fix">
											...
											<div class="map">											
												...
												<div class="bgMap" id="industry_map" style="width:200%; height:200%; -webkit-transform:scale(0.5); -webkit-transform-origin:0% 0%; background:white; display:block; pointer-events: none;"></div>
												<?/*
													주의지역일때 type-ora
													경고지역일때 type-red
													위험지역일때 type-redup
									...
									<tr>
										<td class="fix">
											...
											<div class="map">
												...
												<div class="bgMap" id="agriculture_map" style="width:200%; height:200%; -webkit-transform:scale(0.5); -webkit-transform-origin:0% 0%; background:white; display:block; pointer-events: none;"></div>
