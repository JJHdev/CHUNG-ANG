...
<head>
	...
	<script type="text/javascript" src="${pageContext.request.contextPath}/js/jasperTemplete/govReport_typeB_c.js"></script>
		...
		<article class="conFrame" id="frame3">
			...
			<header>
				<div>
					...
					<h2 class="report_title">한파 영향예보 (제 #-##호) <b class="sggNm">[양주시]</b></h2>
				</div>
				<div>
	...
	<!-- 						<div class="table area2">
		...
		<article class="conFrame layoutTopTable" id="frame4">
			...
			<header>
				<div>
					<span>폭염 한파 분야 재해영향모델 고도화, 연구 시범 서비스</span>
					<h2><b class="report_title">한파 영향예보 (제 #-##호)</b> <b class="sggNm">[양주시]</b></h2>
				</div>
				<div>
					<p class="report_date">2021년 #월 #일 ##시 ##분 발표</p>
				</div>
								...
								<tbody>
									<tr>
										<td class="fix">
											...
											<div class="map" style="background:beige;">
												<div id="facility_map" style="width:125%; height:125%; -webkit-transform:scale(0.8); -webkit-transform-origin:0% 0%; background:white; display:block; pointer-events: none;"></div>
											</div>
										<!--	<article>
												<ul class="dot-list">
													<li>위험에 해당하는 읍면동 단위의 행정구역</li>
