...
<head>
	...
	<script type="text/javascript" src="${pageContext.request.contextPath}/js/jasperTemplete/govReport_typeA_c.js"></script>
...
<body>
	...
	<div class="grayLayout">
		...
		<article class="conFrame" id="frame1">
			...
			<header>
				<div>
					...
					<h2 class="report_title">한파 영향예보 (제 #-##호) <b>[전국]</b></h2>
				</div>
				<div>
			...
			<div class="conPart">
				...
				<div class="conInner">
					...
					<div class="con total">
						<div class="map" style="height:193px;">
						...
						<div class="table">
							<table id="levelTable">
								...
								<thead>
									<tr>
										<th></th>
										<th>서울<br>인천<br>경기</th>
										<th>부산<br>울산<br>경남</th>
										<th>대구<br>경북</th>
										<th>광주<br>전남</th>
										<th>전북</th>
										<th>대전<br>세종<br>충남</th>
										<th>충북</th>
										<th>강원</th>
										<th>제주</th>
									</tr>
						...
						<div class="table">
							<table id="effectTable">
								...
								<tbody>
									<tr>
										<td class="fix">
											<div class="effect-infor">
												<div><span class="bg-gre">120</span><p>관심</p></div>
												<div><span class="bg-ora">14</span><p>주의</p></div>
												<div><span class="bg-red">0</span><p>경고</p></div>
												<div><span class="bg-redup">1</span><p>위험</p></div>
											</div>
										</td>
									</tr>
								</tbody>
				...
				<div class="conInner healthTotal">
					...
					<div class="mapInclude">
					
						<div class="title">
							<h3 class="type2">보건종합</h3>
						</div> <!-- //title -->
						<div class="map">
							<div id="health_map" style="width:250%; height:250%; -webkit-transform:scale(0.4); -webkit-transform-origin:0% 0%; background:white; display:block; pointer-events: none;"></div>
							<div class="ulleungdo_map">
								<div id="health_map_ull" style="width:200%; height:200%; -webkit-transform:scale(0.5); -webkit-transform-origin:0% 0%; background:white; display:block; pointer-events: none;"></div>
							</div>
							<div class="dokdo_map">
								<div id="health_map_dok" style="width:200%; height:200%; -webkit-transform:scale(0.5); -webkit-transform-origin:0% 0%; background:white; display:block; pointer-events: none;"></div>
							</div>
						</div>
						...
						<table id="health_nTable">
							...
							<tbody>
								...
								<tr class="response ordinary">
									<th>
										<i><img src="../images/icon/i-person1.svg"></i>
										<p>일반인</p>
									</th>
									<td>
										<ul class="dot-list">
								...
								<tr class="response age65">
									<th>
										<i><img src="../images/icon/i-person2.svg"></i>
										<p>고령자</p>
									</th>
									<td>
										<ul class="dot-list">
								...
								<tr class="response outdoor">
									<th>
										<i><img src="../images/icon/i-person3.svg"></i>
										<p>야외노동자</p>
									</th>
									<td>
										<ul class="dot-list">
								...
								<tr class="response single">
									<th>
										<i><img src="../images/icon/i-person4.svg"></i>
										<p>1인가구</p>
									</th>
									<td>
										<ul class="dot-list">
								...
								<tr class="response chdb">
									<th>
										<i><img src="../images/icon/i-person5.svg"></i>
										<p>만성질환자</p>
									</th>
									<td>
										<ul class="dot-list">
								...
								<tr class="response lowincome">
									<th>
										<i><img src="../images/icon/i-person6.svg"></i>
										<p>저소득층</p>
									</th>
									<td>
										<ul class="dot-list">
		...
		<article class="conFrame layoutTopTable" id="frame2">
			...
			<div class="conPart">	
								...
								<tbody>
									<tr>
										<td class="fix">
											...
											<table class="innerTable part-detail-state" id="detailTable">
												<colgroup>
													<col style="width:20%;">
													<col style="width:20%;">
													<col style="width:20%;">
				...
				<div class="conInner">
					...
					<div class="title">
						<h3 class="type2">지역별 영향예보 현황</h3>
					</div> <!-- //title -->
					
					<div class="con area-weather">
									...
									<tr>
										<td class="fix">
											...
											<div class="map">
												...
												<div class="bgMap" id="industry_map" style="width:250%; height:250%; -webkit-transform:scale(0.4); -webkit-transform-origin:0% 0%; background:white; display:block; pointer-events: none;"></div>
												<?/*
													주의지역일때 type-ora
													경고지역일때 type-red
													위험지역일때 type-redup
												...
												*/?>
												...
												<div class="ulleungdo_map">
													<div id="industry_map_ull" style="width:200%; height:200%; -webkit-transform:scale(0.5); -webkit-transform-origin:0% 0%; background:white; display:block; pointer-events: none;"></div>
												</div>
												<div class="dokdo_map">
													<div id="industry_map_dok" style="width:200%; height:200%; -webkit-transform:scale(0.5); -webkit-transform-origin:0% 0%; background:white; display:block; pointer-events: none;"></div>
												</div>
												
												<div id="industArea">
													<div class="area-part type-ora">
														<div class="area-part-tit">주의지역</div>
														<div class="area-part-con">경주시, 청양군, 부안군, 남해군</div>
													</div>
												</div>
												
											</div>
											
											<table class="step-effect" id="indust_nTable">
												<colgroup>
													<col style="width:20%;">
													<col style="width:30%;">
													<col style="width:50%;">
												...
												<tbody>
													<tr class="response gunsul">
														<th>건설업</th>
														<td><b class="fc-ora">주의</b></td>
														<td>노동 생산성 저하 위험이 있음</td>
													</tr>
									...
									<tr>
										<td class="fix">
											...
											<div class="map">
												...
												<div class="bgMap" id="agriculture_map" style="width:250%; height:250%; -webkit-transform:scale(0.4); -webkit-transform-origin:0% 0%; background:white; display:block; pointer-events: none;"></div>
												
												<div class="ulleungdo_map">
													<div id="agriculture_map_ull" style="width:200%; height:200%; -webkit-transform:scale(0.5); -webkit-transform-origin:0% 0%; background:white; display:block; pointer-events: none;"></div>
												</div>
												<div class="dokdo_map">
													<div id="agriculture_map_dok" style="width:200%; height:200%; -webkit-transform:scale(0.5); -webkit-transform-origin:0% 0%; background:white; display:block; pointer-events: none;"></div>
												</div>
												
												<div id="agriArea">
													<div class="area-part type-red">
														<div class="area-part-tit">경고지역</div>
														<div class="area-part-con">파주시</div>
													</div>
												</div>
											</div>
											
											<table class="step-effect" id="agri_nTable">
												<colgroup>
													<col style="width:20%;">
													<col style="width:30%;">
													<col style="width:50%;">
												...
												<tbody>
													<tr class="response apple">
														<th>사과</th> 
														<th><b class="fc-red">경고</b></th>
														<th>생육장애가 발생할 위험이 있음(과실 비대 불량, 병해충(진딧물, 응애)으로 인한 영양분 결핍 발생)</th>
													</tr>
													<tr class="response ginseng">
														<th>포도</th>
														<th><b class="fc-redup">위험</b></th>
														<th>생육장애가 발생할 위험이 매우 높음(고사 발생)</th>
													</tr>
												</tbody>
											</table>
